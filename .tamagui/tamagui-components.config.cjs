...
var require_Adapt = __commonJS({
  "node_modules/@tamagui/adapt/dist/cjs/Adapt.js"(exports, module2) {
    ...
    var AdaptParentContext = (0, import_react14.createContext)(null);
    var AdaptContents = /* @__PURE__ */ __name((props) => {
      const context = (0, import_react14.useContext)(AdaptParentContext);
      if (!(context == null ? void 0 : context.Contents)) {
        throw new Error("Adapt not supported by this component");
      }
      return (0, import_react14.createElement)(context.Contents, props);
    }, "AdaptContents");
    AdaptContents["shouldForwardSpace"] = true;
    var useAdaptParent2 = /* @__PURE__ */ __name(({
      Contents
    }) => {
      const [when, setWhen] = (0, import_react14.useState)(null);
      const AdaptProvider = (0, import_react14.useMemo)(() => {
        const context = {
          Contents,
          setWhen
        };
    ...
    var Adapt2 = (0, import_core24.withStaticProperties)(
      /* @__PURE__ */ __name(function Adapt22({ platform: platform2, when, children }) {
        const context = (0, import_react14.useContext)(AdaptParentContext);
        let enabled = !platform2;
        if (platform2 === "touch")
          enabled = import_core24.isTouchable;
        if (platform2 === "native")
          enabled = !import_core24.isWeb;
        if (platform2 === "web")
          enabled = import_core24.isWeb;
...
var require_create_context = __commonJS({
  "node_modules/@tamagui/create-context/dist/cjs/create-context.js"(exports, module2) {
    ...
    __export2(create_context_exports, {
      ...
      createContextScope: () => createContextScope5
    });
    ...
    __name(createContextScope5, "createContextScope");
...
var require_usePresence = __commonJS({
  "node_modules/@tamagui/use-presence/dist/cjs/usePresence.js"(exports, module2) {
    ...
    function usePresence() {
      const context = (0, import_react14.useContext)(import_PresenceContext.PresenceContext);
      if (!context) {
        return [true, null, context];
      }
      const { isPresent: isPresent2, onExitComplete, register } = context;
      const id = (0, import_react14.useId)() || "";
      (0, import_react14.useEffect)(() => register(id), [id, register]);
    ...
    function useIsPresent() {
      return isPresent((0, import_react14.useContext)(import_PresenceContext.PresenceContext));
    }
...
var require_AnimatePresence = __commonJS({
  "node_modules/@tamagui/animate-presence/dist/cjs/AnimatePresence.js"(exports, module2) {
    ...
    function onlyElements(children) {
      const filtered = [];
      import_react14.Children.forEach(children, (child, index3) => {
    ...
    var AnimatePresence2 = /* @__PURE__ */ __name(({
      ...
      let forceRender = (0, import_web7.useForceUpdate)();
      const isClientMounted = (0, import_web7.useDidFinishSSR)();
      const forceRenderLayoutGroup = (0, import_react14.useContext)(import_LayoutGroupContext.LayoutGroupContext).forceRender;
      ...
      const presentChildren = (0, import_react14.useRef)(childrenToRender);
      const allChildren = (0, import_react14.useRef)(/* @__PURE__ */ new Map()).current;
      ...
      (0, import_web7.useIsomorphicLayoutEffect)(() => {
        isInitialRender.current = false;
        updateChildLookup(filteredChildren, allChildren);
        presentChildren.current = childrenToRender;
      });
      const hasWarned = process.env.NODE_ENV === "development" ? (0, import_react14.useRef)(false) : null;
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_jsx_runtime13.Fragment, { children: exiting.size ? childrenToRender : childrenToRender.map((child) => (0, import_react14.cloneElement)(child)) });
    }, "AnimatePresence");
...
var require_useGet = __commonJS({
  "node_modules/@tamagui/use-event/dist/cjs/useGet.js"(exports, module2) {
    ...
    var useIsomorphicLayoutEffect3 = !isWeb8 || isClient3 ? import_react14.useLayoutEffect : import_react14.useEffect;
    function useGet4(currentValue, initialValue, forwardToFunction) {
      const curRef = (0, import_react14.useRef)(initialValue ?? currentValue);
      ...
      (props, forwardedRef) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
          "div",
          {
            ...
            onFocusCapture: (0, import_core24.composeEventHandlers)(
              // @ts-ignore
              props.onFocusCapture,
              focusOutside.onFocusCapture
            ),
            onBlurCapture: (0, import_core24.composeEventHandlers)(
              // @ts-ignore
              props.onBlurCapture,
              focusOutside.onBlurCapture
            ),
            onPointerDownCapture: (0, import_core24.composeEventHandlers)(
              // @ts-ignore
...
var require_getElevation = __commonJS({
  "node_modules/@tamagui/stacks/dist/cjs/getElevation.js"(exports, module2) {
    ...
    var getElevation2 = /* @__PURE__ */ __name((size2, extras) => {
      ...
      const sizeNum = (0, import_core24.isVariable)(token) ? +token.val : size2;
      return getSizedElevation2(sizeNum, extras);
    }, "getElevation");
    var getSizedElevation2 = /* @__PURE__ */ __name((val, { theme, tokens }) => {
      let num = 0;
      if (val === true) {
        const val2 = (0, import_core24.getVariableValue)(tokens.size["true"]);
...
var require_Stacks = __commonJS({
  "node_modules/@tamagui/stacks/dist/cjs/Stacks.js"(exports, module2) {
    ...
    var YStack2 = (0, import_core24.styled)(import_core24.Stack, {
      flexDirection: "column",
      name: "YStack",
      variants: variants2
    });
    var XStack2 = (0, import_core24.styled)(import_core24.Stack, {
      flexDirection: "row",
      name: "XStack",
      variants: variants2
    });
    var ZStack2 = (0, import_core24.styled)(
      YStack2,
      {
        name: "ZStack",
        position: "relative"
...
var require_cjs10 = __commonJS({
  "node_modules/@tamagui/get-size/dist/cjs/index.js"(exports, module2) {
    ...
    var stepTokenUpOrDown2 = /* @__PURE__ */ __name((type, name = "$true", shift2 = 0, bounds = [0]) => {
      const tokens = (0, import_core24.getTokens)({ prefixed: true })[type];
      const keysOrdered = import_core24.tokensKeysOrdered.get(tokens) || Object.keys(tokens);
...
var require_SizableStack = __commonJS({
  "node_modules/@tamagui/stacks/dist/cjs/SizableStack.js"(exports, module2) {
    ...
    var SizableStack2 = (0, import_core24.styled)(import_Stacks3.YStack, {
      name: "SizableStack",
...
var require_ThemeableStack = __commonJS({
  "node_modules/@tamagui/stacks/dist/cjs/ThemeableStack.js"(exports, module2) {
    ...
    var ThemeableStack2 = (0, import_core24.styled)(import_Stacks3.YStack, {
      name: "SizableStack",
      variants: {
        backgrounded: {
          true: {
    ...
    var Portal = /* @__PURE__ */ __name(({ host = ((_a) => (_a = globalThis.document) == null ? void 0 : _a.body)(), ...props }) => {
      const contents = /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
        import_stacks9.YStack,
        {
          contain: "strict",
          fullscreen: true,
          position: import_core24.isWeb ? "fixed" : "absolute",
          maxWidth: import_core24.isWeb ? "100vw" : "100%",
          maxHeight: import_core24.isWeb ? "100vh" : "100%",
          pointerEvents: "none",
          ...props
        }
      );
...
var require_GorhomPortal = __commonJS({
  "node_modules/@tamagui/portal/dist/cjs/GorhomPortal.js"(exports, module2) {
    ...
    var usePortal = /* @__PURE__ */ __name((hostName = "root") => {
      ...
      const deregisterHost2 = (0, import_react14.useCallback)(() => {
        dispatch({
          type: 1,
          hostName
        });
      }, []);
      const addUpdatePortal2 = (0, import_react14.useCallback)((name, node) => {
        dispatch({
          type: 2,
          hostName,
          portalName: name,
      ...
      const removePortal2 = (0, import_react14.useCallback)((name) => {
        dispatch({
          type: 3,
          hostName,
          portalName: name
    ...
    var PortalProviderComponent = /* @__PURE__ */ __name(({
      ...
      const [state, dispatch] = (0, import_react14.useReducer)(reducer, INITIAL_STATE);
      const transitionDispatch = (0, import_react14.useMemo)(() => {
        const next = /* @__PURE__ */ __name((value) => {
          (0, import_react14.startTransition)(() => {
            dispatch(value);
          });
        }, "next");
        return next;
    ...
    var PortalHostComponent = /* @__PURE__ */ __name((props) => {
      ...
      if (forwardProps) {
        return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_jsx_runtime13.Fragment, { children: state.map((item) => {
          let next = item.node;
          if (forwardProps) {
            return import_react14.default.Children.map(next, (child) => {
              return import_react14.default.isValidElement(child) ? import_react14.default.cloneElement(child, { key: child.key, ...forwardProps }) : child;
            });
          }
          return next;
        }) });
    ...
    var PortalHost2 = (0, import_react14.memo)(PortalHostComponent);
    ...
    var PortalComponent = /* @__PURE__ */ __name((props) => {
      ...
      const handleOnMount = (0, import_core24.useEvent)(() => {
      ...
      const handleOnUnmount = (0, import_core24.useEvent)(() => {
      ...
      const handleOnUpdate = (0, import_core24.useEvent)(() => {
    ...
    var PortalItem2 = (0, import_react14.memo)(PortalComponent);
...
var require_useControllableState = __commonJS({
  "node_modules/@tamagui/use-controllable-state/dist/cjs/useControllableState.js"(exports, module2) {
    ...
    function useControllableState2({
      ...
      const [state, setState] = (0, import_react14.useState)(prop ?? defaultProp);
      const previous = (0, import_react14.useRef)(state);
      ...
      const transitionFn = transition ? import_react14.startTransition : emptyCallbackFn2;
      (0, import_react14.useEffect)(() => {
        if (prop === void 0)
          return;
...
var require_SheetContext = __commonJS({
  "node_modules/@tamagui/sheet/dist/cjs/SheetContext.js"(exports, module2) {
    ...
    var import_create_context6 = require_cjs3();
    var import_constants = require_constants2();
    var [createSheetContext, createSheetScope2] = (0, import_create_context6.createContextScope)(import_constants.SHEET_NAME);
...
var require_ScrollView = __commonJS({
  "node_modules/@tamagui/scroll-view/dist/cjs/ScrollView.js"(exports, module2) {
    ...
    (0, import_web7.setupReactNative)({
      ScrollView: import_react_native6.ScrollView
    });
    var ScrollView2 = (0, import_web7.styled)(
...
var require_SheetScrollView = __commonJS({
  "node_modules/@tamagui/sheet/dist/cjs/SheetScrollView.js"(exports, module2) {
    ...
    var SheetScrollView = (0, import_react14.forwardRef)(
      ({ __scopeSheet, children, ...props }, ref) => {
        ...
        const [percentToPadBottom, setPercentToPadBottom] = (0, import_react14.useState)(0);
        const next = 100 - percentOpened;
        if (open && next !== percentToPadBottom) {
          setPercentToPadBottom(next);
        }
        const state = (0, import_react14.useRef)({
          lastPageY: 0,
          dragAt: 0,
          dys: [],
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
          ...
          {
            ref: (0, import_core24.composeRefs)(scrollRef, ref),
            flex: 1,
            ...
            ...props,
            children: [
              (0, import_react14.useMemo)(() => children, [children]),
              /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_core24.Stack, { height: percentToPadBottom / 100 * frameSize, width: 0 })
            ]
          }
        );
      }
...
var require_Sheet = __commonJS({
  "node_modules/@tamagui/sheet/dist/cjs/Sheet.js"(exports, module2) {
    ...
    var import_use_controllable_state3 = require_cjs16();
    var import_react14 = __toESM2(require("react"));
    var import_react_native6 = require("react-native-web-lite");
    var import_constants = require_constants2();
    var import_SheetContext = require_SheetContext();
    ...
    var SheetHandleFrame = (0, import_core24.styled)(import_stacks9.XStack, {
    ...
    var SheetOverlayFrame = (0, import_core24.styled)(import_stacks9.YStack, {
      ...
      ({ __scopeSheet, ...props }) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
          SheetOverlayFrame,
          {
            ...
            ...props,
            onPress: (0, import_core24.mergeEvent)(
              props.onPress,
    ...
    var selectionStyleSheet = import_core24.isClient ? document.createElement("style") : null;
    if (selectionStyleSheet) {
      document.head.appendChild(selectionStyleSheet);
    }
    var SheetFrameFrame = (0, import_core24.styled)(import_stacks9.YStack, {
    ...
    var ParentSheetContext = (0, import_react14.createContext)({
      zIndex: 40
    });
    var useSheetContoller = /* @__PURE__ */ __name(() => {
      const controller = (0, import_react14.useContext)(SheetControllerContext);
    ...
    var Sheet = (0, import_core24.withStaticProperties)(
      (0, import_react14.forwardRef)(/* @__PURE__ */ __name(function Sheet2(props, ref) {
        const hydrated = (0, import_core24.useDidFinishSSR)();
    ...
    var SheetImplementation = (0, import_core24.themeable)(
      (0, import_react14.forwardRef)(/* @__PURE__ */ __name(function SheetImplementation2(props, ref) {
        const parentSheet = (0, import_react14.useContext)(ParentSheetContext);
        ...
        const driver = (0, import_core24.getAnimationDriver)();
        if (!driver) {
        ...
        const [open, setOpen] = (0, import_use_controllable_state3.useControllableState)({
        ...
        const [position_, setPosition_] = (0, import_use_controllable_state3.useControllableState)({
          prop: positionProp,
        ...
        const at = (0, import_react14.useRef)(0);
        useAnimatedNumberReaction(animatedNumber, (value) => {
          at.current = value;
          scrollBridge.paneY = value;
        });
        const [isResizing, setIsResizing] = (0, import_react14.useState)(true);
        (0, import_core24.useIsomorphicLayoutEffect)(() => {
          if (!isResizing) {
            setIsResizing(true);
          }
        ...
        const positions = (0, import_react14.useMemo)(
          () => snapPoints.map((point) => getPercentSize(point, frameSize)),
          [frameSize, snapPoints]
        );
        const [opacity, setOpacity] = (0, import_react14.useState)(open ? 1 : 0);
        if (open && opacity === 0) {
          setOpacity(1);
        }
        (0, import_react14.useEffect)(() => {
        ...
        const animateTo = (0, import_core24.useEvent)((position2) => {
        ...
        const [isShowingInnerSheet, setIsShowingInnerSheet] = (0, import_react14.useState)(false);
        const shouldHideParentSheet = !import_core24.isWeb && modal && isShowingInnerSheet;
        const parentSheetContext = (0, import_react14.useContext)(SheetInsideSheetContext);
        const onInnerSheet = (0, import_react14.useCallback)((hasChild) => {
        ...
        import_react14.default.Children.forEach(childrenProp, (child) => {
          var _a, _b;
          if ((0, import_react14.isValidElement)(child)) {
        ...
        const nextParentContext = (0, import_react14.useMemo)(
          () => ({
            zIndex
          }),
          [zIndex]
        );
        const handleLayout = (0, import_react14.useCallback)((e) => {
          var _a;
          let next = (_a = e.nativeEvent) == null ? void 0 : _a.layout.height;
          if (import_core24.isWeb && import_core24.isTouchable && !open) {
            next += 100;
          }
          if (!next)
            return;
        ...
        const adaptContext = (0, import_react14.useContext)(import_adapt2.AdaptParentContext);
        if (modal) {
          const modalContents = /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_portal3.Portal, { zIndex, ...portalProps, children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_core24.Theme, { forceClassName: true, name: themeName, children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_adapt2.AdaptParentContext.Provider, { value: adaptContext, children: contents }) }) });
    ...
    var SheetInsideSheetContext = (0, import_react14.createContext)(null);
    ...
    var SheetControllerContext = (0, import_react14.createContext)(null);
    var SheetController2 = /* @__PURE__ */ __name(({
      children,
      onOpenChange: onOpenChangeProp,
      ...value
    }) => {
      const onOpenChange = (0, import_core24.useEvent)(onOpenChangeProp);
      const memoValue = (0, import_react14.useMemo)(
        () => ({
          open: value.open,
          hidden: value.hidden,
...
var require_cjs19 = __commonJS({
  "node_modules/@tamagui/get-font-sized/dist/cjs/index.js"(exports, module2) {
    ...
    var getFontSized4 = /* @__PURE__ */ __name((sizeTokenIn = "$true", { fonts, props }) => {
      var _a, _b, _c;
      const family = (0, import_core24.getVariableValue)(props.fontFamily) || "$body";
    ...
    function getDefaultSizeToken(font) {
      ...
      const sizeTokens = "$true" in font.size ? font.size : (0, import_core24.getTokens)().size;
...
var require_SizableText = __commonJS({
  "node_modules/@tamagui/text/dist/cjs/SizableText.js"(exports, module2) {
    ...
    var import_web7 = require("@tamagui/core-node");
    var SizableText2 = (0, import_web7.styled)(import_web7.Text, {
      name: "SizableText",
      fontFamily: "$body",
      variants: {
...
var require_Paragraph = __commonJS({
  "node_modules/@tamagui/text/dist/cjs/Paragraph.js"(exports, module2) {
    ...
    var Paragraph2 = (0, import_web7.styled)(import_SizableText2.SizableText, {
      name: "Paragraph",
      tag: "p",
      userSelect: "auto",
      color: "$color",
...
var require_Headings = __commonJS({
  "node_modules/@tamagui/text/dist/cjs/Headings.js"(exports, module2) {
    ...
    var Heading2 = (0, import_web7.styled)(import_Paragraph2.Paragraph, {
      tag: "span",
      name: "Heading",
    ...
    var H12 = (0, import_web7.styled)(Heading2, {
      name: "H1",
      tag: "h1",
      size: "$10"
    });
    var H22 = (0, import_web7.styled)(Heading2, {
      name: "H2",
      tag: "h2",
      size: "$9"
    });
    var H32 = (0, import_web7.styled)(Heading2, {
      name: "H3",
      tag: "h3",
      size: "$8"
    });
    var H42 = (0, import_web7.styled)(Heading2, {
      name: "H4",
      tag: "h4",
      size: "$7"
    });
    var H52 = (0, import_web7.styled)(Heading2, {
      name: "H5",
      tag: "h5",
      size: "$6"
    });
    var H62 = (0, import_web7.styled)(Heading2, {
      name: "H6",
      tag: "h6",
      size: "$5"
    });
...
var require_Dialog = __commonJS({
  "node_modules/@tamagui/dialog/dist/cjs/Dialog.js"(exports, module2) {
    ...
    var [createDialogContext2, createDialogScope2] = (0, import_create_context6.createContextScope)(DIALOG_NAME2);
    var [DialogProvider2, useDialogContext2] = createDialogContext2(DIALOG_NAME2);
    var TRIGGER_NAME3 = "DialogTrigger";
    var DialogTriggerFrame2 = (0, import_core24.styled)(import_stacks9.YStack, {
      name: TRIGGER_NAME3
    });
    ...
    var DialogPortalFrame2 = (0, import_core24.styled)(import_stacks9.YStack, {
      alignItems: "center",
    ...
    function DialogPortalItemContent2(props) {
      ...
      if (space || separator) {
        childrenSpaced = (0, import_core24.spacedChildren)({
          children,
          separator,
          space,
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(DialogProvider2, { scope: __scopeDialog, ...context, children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_core24.Theme, { name: themeName, children: childrenSpaced }) });
    }
    ...
    var DialogOverlayFrame2 = (0, import_core24.styled)(import_stacks9.ThemeableStack, {
      name: OVERLAY_NAME2,
      backgrounded: true,
      fullscreen: true
    });
    ...
    var DialogContentFrame2 = (0, import_core24.styled)(import_stacks9.ThemeableStack, {
      name: CONTENT_NAME2,
      tag: "dialog",
      position: "relative",
      backgrounded: true,
    ...
    var DialogTitleFrame2 = (0, import_core24.styled)(import_text5.H2, {
      name: TITLE_NAME2
    });
    ...
    var DialogDescriptionFrame2 = (0, import_core24.styled)(import_text5.Paragraph, {
    ...
    var [DialogWarningProvider2, useWarningContext2] = (0, import_create_context6.createContext)(TITLE_WARNING_NAME2, {
...
For more information, see https://radix-ui.com/primitives/docs/components/${titleWarningContext.docsSlug}`;
    ...
    var Dialog3 = (0, import_core24.withStaticProperties)(
      React13.forwardRef(/* @__PURE__ */ __name(function Dialog22(props, ref) {
        ...
        const scopeId = (0, import_core24.useId)();
        const contentId = (0, import_core24.useId)();
        const titleId = (0, import_core24.useId)();
        const descriptionId = (0, import_core24.useId)();
    ...
    var DialogSheetController2 = /* @__PURE__ */ __name((props) => {
      ...
      const getShowSheet = (0, import_core24.useGet)(showSheet);
      return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
...
var require_AlertDialog = __commonJS({
  "node_modules/@tamagui/alert-dialog/dist/cjs/AlertDialog.js"(exports, module2) {
    ...
    var [createAlertDialogContext, createAlertDialogScope] = (0, import_create_context6.createContextScope)(ROOT_NAME, [
      import_dialog.createDialogScope
    ]);
    var useDialogScope = (0, import_dialog.createDialogScope)();
    var TRIGGER_NAME3 = "AlertDialogTrigger";
    var NativeAlertDialogTriggerFrame = (0, import_core24.styled)(import_stacks9.YStack, {
      name: "DialogTrigger"
    });
      ...
      (props, forwardedRef) => {
        if (props["__native"]) {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
            ...
            {
              ...rest,
              onPress: (0, import_core24.composeEventHandlers)(onPress, __onPress)
            }
          );
        }
          ...
          import_dialog.DialogWarningProvider,
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(AlertDialogContentProvider, { scope: __scopeAlertDialog, cancelRef, children: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
              import_dialog.DialogContent,
              {
                ...
                ...contentProps,
                ref: composedRefs,
                onOpenAutoFocus: (0, import_core24.composeEventHandlers)(
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_core24.Slottable, { children }),
      ...
      if (process.env.TAMAGUI_TARGET === "native") {
        ...
        forEachChildDeep(React13.Children.toArray(props.children), (child) => {
          if (!React13.isValidElement(child))
            return false;
          const name = (0, import_core24.isTamaguiElement)(child) ? child.type.staticConfig.componentName : child.type["displayName"];
          switch (name) {
            case TRIGGER_NAME3: {
    ...
    var AlertDialog = (0, import_core24.withStaticProperties)(AlertDialogInner, {
...
var require_Image = __commonJS({
  "node_modules/@tamagui/image/dist/cjs/Image.js"(exports, module2) {
    ...
    var StyledImage = (0, import_core24.styled)(import_react_native6.Image, {
      name: "Image",
      position: "relative",
      source: { uri: "" },
      zIndex: 1
    ...
    var Image2 = StyledImage.extractable((inProps) => {
      const props = (0, import_core24.useMediaPropsActive)(inProps);
      const { src, ...rest } = props;
      const source = typeof src === "string" ? { uri: src, ...import_core24.isWeb && { width: props.width, height: props.height } } : src;
...
var require_Square = __commonJS({
  "node_modules/@tamagui/shapes/dist/cjs/Square.js"(exports, module2) {
    ...
    var Square2 = (0, import_web7.styled)(import_stacks9.ThemeableStack, {
      name: "Square",
      alignItems: "center",
      justifyContent: "center",
      variants: {
...
var require_Circle = __commonJS({
  "node_modules/@tamagui/shapes/dist/cjs/Circle.js"(exports, module2) {
    ...
    var Circle = (0, import_web7.styled)(import_Square.Square, {
      name: "Circle",
      circular: true
    });
  }
...
var require_getFontSize = __commonJS({
  "node_modules/@tamagui/font-size/dist/cjs/getFontSize.js"(exports, module2) {
    ...
    var getFontSize2 = /* @__PURE__ */ __name((inSize, opts) => {
      ...
      if ((0, import_core24.isVariable)(res)) {
        return +res.val;
      }
      return res ? +res : 16;
    }, "getFontSize");
    var getFontSizeVariable = /* @__PURE__ */ __name((inSize, opts) => {
      ...
      const conf = (0, import_core24.getConfig)();
...
var require_getSpace = __commonJS({
  "node_modules/@tamagui/helpers-tamagui/dist/cjs/getSpace.js"(exports, module2) {
    ...
    var getSpace = /* @__PURE__ */ __name((token, sizeUpOrDownBy = 0) => {
      const spaces = (0, import_core24.getTokens)().space;
...
var require_useCurrentColor = __commonJS({
  "node_modules/@tamagui/helpers-tamagui/dist/cjs/useCurrentColor.js"(exports, module2) {
    ...
    var useCurrentColor = /* @__PURE__ */ __name((colorProp) => {
      ...
      return (0, import_core24.variableToString)(theme[colorProp] || colorProp || theme.color);
    }, "useCurrentColor");
  }
});
  ...
  "node_modules/@tamagui/helpers-tamagui/dist/cjs/useGetThemedIcon.js"(exports, module2) {
    ...
    var useGetThemedIcon2 = /* @__PURE__ */ __name((props) => {
      ...
      return (el) => {
        if (!el)
          return el;
        if ((0, import_react14.isValidElement)(el)) {
          return (0, import_react14.cloneElement)(el, {
            ...props,
            // @ts-expect-error
            ...el.props
          });
        }
        return (0, import_react14.createElement)(el, props);
      };
    }, "useGetThemedIcon");
  }
});
  ...
  "node_modules/@tamagui/focusable/dist/cjs/focusableInputHOC.js"(exports, module2) {
    ...
    function focusableInputHOC3(Component) {
      const component = Component.extractable(
        (0, import_react14.forwardRef)(
          (props, ref) => {
            const isInput = (0, import_web7.isTamaguiComponent)(Component) && Component.staticConfig.isInput;
            const inputValue = (0, import_react14.useRef)(props.value || props.defaultValue || "");
            const unregisterFocusable = (0, import_react14.useRef)();
            const inputRef = (0, import_react14.useCallback)(
              (input) => {
                var _a;
                if (!props.id)
                  return;
            ...
            const onChangeText = (0, import_web7.useEvent)((value) => {
              var _a;
...
var require_ListItem = __commonJS({
  "node_modules/@tamagui/list-item/dist/cjs/ListItem.js"(exports, module2) {
    ...
    var import_react14 = require("react");
    var NAME3 = "ListItem";
    var ListItemFrame = (0, import_core24.styled)(import_stacks9.ThemeableStack, {
      name: NAME3,
      tag: "li",
      variants: {
        unstyled: {
    ...
    var ListItemText = (0, import_core24.styled)(import_text5.SizableText, {
      name: "ListItemText",
      color: "$color",
      userSelect: "none",
      flexGrow: 1,
    ...
    var ListItemSubtitle = (0, import_core24.styled)(ListItemText, {
    ...
    var ListItemTitle = (0, import_core24.styled)(ListItemText, {
      name: "ListItemTitle"
    });
    var useListItem = /* @__PURE__ */ __name((props, {
      ...
      const mediaActiveProps = (0, import_core24.useMediaPropsActive)(props);
      ...
      const spaceSize = (0, import_core24.getVariableValue)((0, import_core24.getTokens)().space[mediaActiveProps.space] ?? iconSize) * scaleSpace;
        ...
        props: {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(import_jsx_runtime13.Fragment, { children: [
            themedIcon ? /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(import_jsx_runtime13.Fragment, { children: [
              themedIcon,
              /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_core24.Spacer, { size: spaceSize })
            ] }) : null,
            title || subTitle ? /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(import_stacks9.YStack, { flex: 1, children: [
              ...
              subTitle ? /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(import_jsx_runtime13.Fragment, { children: [
                /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_core24.Spacer, { flex: true, size: spaceSize * 0.333 }),
    ...
    var ListItemComponent = (0, import_react14.forwardRef)((props, ref) => {
    ...
    var ListItem = (0, import_core24.withStaticProperties)(
      ListItemFrame.extractable(
        (0, import_core24.themeable)(ListItemComponent, { componentName: NAME3 }),
...
var require_useFloating = __commonJS({
  "node_modules/@tamagui/floating/dist/cjs/useFloating.js"(exports, module2) {
    ...
    var FloatingOverrideContext2 = (0, import_react14.createContext)(null);
    var useFloating4 = /* @__PURE__ */ __name((props) => {
      var _a;
      const context = (0, import_react14.useContext)(FloatingOverrideContext2);
...
var require_Popper = __commonJS({
  "node_modules/@tamagui/popper/dist/cjs/Popper.js"(exports, module2) {
    ...
    var [createPopperContext, createScope] = (0, import_create_context6.createContextScope)(POPPER_NAME);
    ...
    var PopperAnchor = import_stacks9.YStack.extractable(
      React13.forwardRef(/* @__PURE__ */ __name(function PopperAnchor2(props, forwardedRef) {
    ...
    var PopperContentFrame = (0, import_core24.styled)(import_stacks9.ThemeableStack, {
      name: "PopperContent",
      variants: {
        unstyled: {
          false: {
    ...
    var PopperArrowFrame = (0, import_core24.styled)(import_stacks9.YStack, {
      name: "PopperArrow",
      variants: {
        unstyled: {
          false: {
    ...
    var PopperArrowOuterFrame = (0, import_core24.styled)(import_stacks9.YStack, {
...
var require_useFloatingContext = __commonJS({
  "node_modules/@tamagui/popover/dist/cjs/useFloatingContext.js"(exports, module2) {
    ...
    var import_react14 = (init_floating_ui_react_esm(), __toCommonJS(floating_ui_react_esm_exports));
    var import_react22 = require("react");
    var useFloatingContext = /* @__PURE__ */ __name(({ open, setOpen, breakpointActive }) => (0, import_react22.useCallback)(
      (props) => {
        const floating = (0, import_react14.useFloating)({
          ...props,
          open,
          onOpenChange: setOpen
        });
        const { getReferenceProps, getFloatingProps } = (0, import_react14.useInteractions)([
          ...
          //   keyboardOnly: true,
          // }),
          (0, import_react14.useRole)(floating.context, { role: "dialog" }),
          (0, import_react14.useDismiss)(floating.context, {
            enabled: !breakpointActive
          })
        ]);
        return {
...
var require_Popover = __commonJS({
  "node_modules/@tamagui/popover/dist/cjs/Popover.js"(exports, module2) {
    ...
    var [createPopoverContext, createPopoverScopeInternal] = (0, import_create_context6.createContextScope)(
      POPOVER_NAME,
    ...
    function PopoverContentPortal(props) {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_portal3.Portal, { zIndex, children: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(import_core24.Theme, { forceClassName: true, name: themeName, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_core24.Stack, { zIndex: zIndex + 1, children: contents })
      ] }) });
    }
            ...
            import_remove_scroll2.RemoveScroll,
            {
              ...
              children: trapFocus === false ? children : /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
                import_focus_scope2.FocusScope,
                {
                  ...
                  onMountAutoFocus: onOpenAutoFocus,
                  onUnmountAutoFocus: onCloseAutoFocus,
                  children: import_core24.isWeb ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { style: { display: "contents" }, children }) : children
                }
              )
            }
          )
    ...
    var Popover = (0, import_core24.withStaticProperties)(
      /* @__PURE__ */ __name(function Popover2(props) {
        ...
        const internalId = (0, import_core24.useId)();
        ...
        const popoverContext = {
          ...
          sheetBreakpoint,
          contentId: (0, import_core24.useId)(),
          triggerRef,
          open,
          breakpointActive,
          onOpenChange: setOpen,
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(AdaptProvider, { children: import_core24.isWeb ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_floating.FloatingOverrideContext.Provider, { value: floatingContext, children: contents }) : contents });
      }, "Popover2"),
      {
...
var require_Progress = __commonJS({
  "node_modules/@tamagui/progress/dist/cjs/Progress.js"(exports, module2) {
    ...
    var [createProgressContext, createProgressScope] = (0, import_create_context6.createContextScope)(PROGRESS_NAME);
    var [ProgressProvider, useProgressContext] = createProgressContext(PROGRESS_NAME);
    var INDICATOR_NAME = "ProgressIndicator";
    var ProgressIndicatorFrame = (0, import_core24.styled)(import_stacks9.ThemeableStack, {
      name: INDICATOR_NAME,
      height: "100%",
      width: "100%",
      backgrounded: true
...
Defaulting to \`null\`.`;
    ...
    var DEFAULT_MAX = 100;
    var ProgressFrame = (0, import_core24.styled)(import_stacks9.ThemeableStack, {
      name: PROGRESS_NAME,
      borderRadius: 1e5,
      overflow: "hidden",
      backgrounded: true,
      variants: {
        size: {
          "...size": (val) => {
            const size2 = Math.round((0, import_core24.getVariableValue)((0, import_get_size2.getSize)(val)) * 0.25);
            return {
              height: size2,
              minWidth: (0, import_core24.getVariableValue)(size2) * 20,
              width: "100%"
            };
          }
        }
    ...
    var Progress = (0, import_core24.withStaticProperties)(
...
var require_Label = __commonJS({
  "node_modules/@tamagui/label/dist/cjs/Label.js"(exports, module2) {
    ...
    var React13 = __toESM2(require("react"));
    var NAME3 = "Label";
    var [LabelProvider2, useLabelContextImpl2] = (0, import_create_context6.createContext)(NAME3, {
      id: void 0,
      controlRef: { current: null }
    });
    var LabelFrame2 = (0, import_web7.styled)(import_text5.SizableText, {
      name: "Label",
      tag: "label",
      variants: {
        unstyled: {
    ...
    var LabelComponent2 = React13.forwardRef(
      (props, forwardedRef) => {
        ...
        const ref = React13.useRef(null);
        const composedRefs = (0, import_compose_refs3.useComposedRefs)(forwardedRef, ref);
        const backupId = (0, import_web7.useId)();
        const id = idProp ?? backupId;
        if (import_web7.isWeb) {
          React13.useEffect(() => {
            if (htmlFor) {
    ...
    var Label2 = LabelFrame2.extractable((0, import_web7.themeable)(LabelComponent2), {
      neverFlatten: true
    });
...
var require_RadioGroup = __commonJS({
  "node_modules/@tamagui/radio-group/dist/cjs/RadioGroup.js"(exports, module2) {
    ...
    var [createRadioGroupContext, createRadioGroupScope] = (0, import_create_context6.createContextScope)(RADIO_GROUP_NAME);
    var [RadioGroupProvider, useRadioGroupContext] = createRadioGroupContext(RADIO_GROUP_NAME);
    var getState2 = /* @__PURE__ */ __name((checked) => {
      return checked ? "checked" : "unchecked";
    }, "getState");
    var RADIO_GROUP_INDICATOR_NAME = "RadioGroupIndicator";
    var RadioIndicatorFrame = (0, import_core24.styled)(import_stacks9.ThemeableStack, {
    ...
    var RadioGroupItemFrame = (0, import_core24.styled)(import_stacks9.ThemeableStack, {
        ...
        size: {
          "...size": (value, { props }) => {
            const size2 = Math.floor(
              (0, import_core24.getVariableValue)((0, import_get_size2.getSize)(value)) * (props["scaleSize"] ?? 0.5)
            );
            return {
              width: size2,
              height: size2
    ...
    var RadioGroupItem = RadioGroupItemFrame.extractable(
      React13.forwardRef(
        (props, forwardedRef) => {
          ...
          const ref = React13.useRef(null);
          const composedRefs = (0, import_core24.useComposedRefs)(forwardedRef, (node) => setButton(node), ref);
          const isArrowKeyPressedRef = React13.useRef(false);
          const isFormControl = import_core24.isWeb ? button ? Boolean(button.closest("form")) : true : false;
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(RadioGroupItemProvider, { checked, scope: __scopeRadioGroup, children: import_core24.isWeb && native ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
            BubbleInput,
            {
              control: button,
            ...
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
              RadioGroupItemFrame,
              {
                ...
                ...itemProps,
                onPress: (0, import_core24.composeEventHandlers)(props.onPress, (event) => {
                  if (!checked) {
                    onChange == null ? void 0 : onChange(value);
                  }
                  if (isFormControl) {
                ...
                ...import_core24.isWeb && {
                  onKeyDown: (0, import_core24.composeEventHandlers)(
                    props.onKeyDown,
                    (event) => {
                      if (event.key === "Enter")
                        event.preventDefault();
                  ...
                  onFocus: (0, import_core24.composeEventHandlers)(itemProps.onFocus, () => {
                    var _a;
    ...
    var RadioGroupFrame = (0, import_core24.styled)(import_stacks9.ThemeableStack, {
    ...
    var RadioGroup = (0, import_core24.withStaticProperties)(
...
var require_Separator = __commonJS({
  "node_modules/@tamagui/separator/dist/cjs/Separator.js"(exports, module2) {
    ...
    var import_core24 = require("@tamagui/core-node");
    var Separator = (0, import_core24.styled)(import_core24.Stack, {
      name: "Separator",
      borderColor: "$borderColor",
      flexShrink: 0,
      borderWidth: 0,
      ...
      variants: {
        vertical: {
          true: {
            y: 0,
            x: -0.5,
            height: import_core24.isWeb ? "initial" : "auto",
            ...
            maxHeight: import_core24.isWeb ? "initial" : "auto",
            width: 0,
            maxWidth: 0,
            borderBottomWidth: 0,
            borderRightWidth: 1
...
var require_context = __commonJS({
  "node_modules/@tamagui/select/dist/cjs/context.js"(exports, module2) {
    ...
    var [createSelectContext, createSelectScope] = (0, import_create_context6.createContextScope)(import_constants.SELECT_NAME);
...
var require_SelectContent = __commonJS({
  "node_modules/@tamagui/select/dist/cjs/SelectContent.js"(exports, module2) {
    ...
    var SelectContent = /* @__PURE__ */ __name(({
      ...
      const contents = /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_core24.Theme, { forceClassName: true, name: themeName, children });
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_react14.FloatingPortal, { children: context.open ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_react14.FloatingOverlay, { style: { zIndex }, lockScroll: !touch, children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_focus_scope2.FocusScope, { loop: true, trapped: true, ...focusScopeProps, children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_dismissable2.Dismissable, { children: contents }) }) }) : /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { style: { display: "none" }, children: contents }) });
    }, "SelectContent");
  }
});
...
var require_SelectImpl = __commonJS({
  "node_modules/@tamagui/select/dist/cjs/SelectImpl.js"(exports, module2) {
    ...
    var SelectInlineImpl = /* @__PURE__ */ __name((props) => {
      ...
      if (import_core24.isWeb && import_core24.isClient) {
        React13.useEffect(() => {
          if (!open)
            return;
      ...
      const updateFloatingSize = (0, import_react14.size)({
        apply({
          availableHeight,
          rects: {
            reference: { width }
      ...
      const { x, y, reference, floating, strategy, context, refs } = (0, import_react14.useFloating)({
        open,
        onOpenChange: setOpen,
        whileElementsMounted: import_react14.autoUpdate,
        placement: "bottom-start",
        middleware: fallback ? [
          (0, import_react14.offset)(5),
          ...[
            touch ? (0, import_react14.shift)({ crossAxis: true, padding: import_constants.WINDOW_PADDING }) : (0, import_react14.flip)({ padding: import_constants.WINDOW_PADDING })
          ],
          updateFloatingSize
        ] : [
          (0, import_react14.inner)({
      ...
      const interactions = (0, import_react14.useInteractions)([
        (0, import_react14.useClick)(context, { event: "mousedown" }),
        (0, import_react14.useDismiss)(context, { outsidePress: true }),
        (0, import_react14.useRole)(context, { role: "listbox" }),
        (0, import_react14.useInnerOffset)(context, {
          enabled: !fallback,
          onChange: setInnerOffset,
          overflowRef
        }),
        (0, import_react14.useListNavigation)(context, {
          listRef: listItemsRef,
          activeIndex,
          selectedIndex,
          onNavigate: setActiveIndex
        }),
        (0, import_react14.useTypeahead)(context, {
    ...
    var SelectScrollButtonImpl = React13.memo(
      React13.forwardRef(
        (props, forwardedRef) => {
          ...
          const { x, y, reference, floating, strategy, update, refs } = (0, import_react14.useFloating)({
            open: open && isVisible,
            strategy: "fixed",
            placement: dir === "up" ? "top" : "bottom",
            middleware: [(0, import_react14.offset)(({ rects }) => -rects.floating.height)],
            whileElementsMounted: (...args) => (0, import_react14.autoUpdate)(...args, { animationFrame: true })
          });
...
var require_SelectViewport = __commonJS({
  "node_modules/@tamagui/select/dist/cjs/SelectViewport.js"(exports, module2) {
    ...
    var import_context = require_context();
    var import_useSelectBreakpointActive = require_useSelectBreakpointActive();
    var SelectViewportFrame = (0, import_core25.styled)(import_stacks9.ThemeableStack, {
    ...
    var SelectViewport = React13.forwardRef(
      (props, forwardedRef) => {
        ...
        if (breakpointActive || !import_core24.isWeb) {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(import_jsx_runtime13.Fragment, { children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_react14.FloatingFocusManager, { context: context.floatingContext, children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
            SelectViewportFrame,
            {
              size: context.size,
              role: "presentation",
...
var require_Select = __commonJS({
  "node_modules/@tamagui/select/dist/cjs/Select.js"(exports, module2) {
    ...
    var SelectValueFrame = (0, import_core24.styled)(import_text5.Paragraph, {
      name: VALUE_NAME,
      userSelect: "none"
    });
    ...
    var SelectIcon = (0, import_core24.styled)(import_stacks9.XStack, {
      name: "SelectIcon",
      // @ts-ignore
      "aria-hidden": true,
    ...
    var SelectItem = React13.forwardRef(
      (props, forwardedRef) => {
        ...
        const textId = (0, import_core24.useId)();
        const {
          selectedIndex,
          setSelectedIndex,
          listRef,
    ...
    var SelectItemTextFrame = (0, import_core24.styled)(import_text5.SizableText, {
      name: ITEM_TEXT_NAME,
      userSelect: "none"
    });
    ...
    var SelectItemIndicatorFrame = (0, import_core24.styled)(import_stacks9.XStack, {
      name: ITEM_TEXT_NAME
    });
    ...
    var [SelectGroupContextProvider, useSelectGroupContext] = (0, import_context.createSelectContext)(GROUP_NAME2);
    var SelectGroupFrame = (0, import_core24.styled)(import_stacks9.YStack, {
      name: GROUP_NAME2,
      width: "100%"
    });
    var SelectGroup = React13.forwardRef(
      (props, forwardedRef) => {
        ...
        const groupId = (0, import_core24.useId)();
    ...
    var SelectSeparator = (0, import_core24.styled)(import_separator.Separator, {
    ...
    var Select = (0, import_core24.withStaticProperties)(
      (props) => {
        const {
          __scopeSelect,
          children,
        ...
        const id = (0, import_core24.useId)();
        ...
        const SelectImpl = isSheet || !import_core24.isWeb ? SelectSheetImpl : import_SelectImpl.SelectInlineImpl;
...
var require_constants4 = __commonJS({
  "node_modules/@tamagui/slider/dist/cjs/constants.js"(exports, module2) {
    ...
    var [createSliderContext, createSliderScope] = (0, import_create_context6.createContextScope)(SLIDER_NAME);
...
var require_SliderImpl = __commonJS({
  "node_modules/@tamagui/slider/dist/cjs/SliderImpl.js"(exports, module2) {
    ...
    var DirectionalYStack2 = (0, import_core24.styled)(import_stacks9.YStack, {
      variants: {
        orientation: {
          horizontal: {},
          vertical: {}
    ...
    var SliderFrame2 = (0, import_core24.styled)(DirectionalYStack2, {
      position: "relative",
      variants: {
        size: (val, extras) => {
          const orientation = extras.props.orientation;
          const size2 = Math.round((0, import_core24.getVariableValue)((0, import_get_size2.getSize)(val)) / 6);
      ...
      (props, forwardedRef) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
          SliderFrame2,
          {
            ...
            onResponderGrant: (0, import_core24.composeEventHandlers)(props.onResponderGrant, (event) => {
              const target = event.target;
              const isStartingOnThumb = context.thumbs.has(target);
              if (import_core24.isWeb && target instanceof HTMLElement) {
            ...
            onResponderMove: (0, import_core24.composeEventHandlers)(props.onResponderMove, (event) => {
              event.stopPropagation();
              onSlideMove(event);
            }),
            onResponderRelease: (0, import_core24.composeEventHandlers)(props.onResponderRelease, (event) => {
              onSlideEnd(event);
            })
          }
        );
...
var require_Slider = __commonJS({
  "node_modules/@tamagui/slider/dist/cjs/Slider.js"(exports, module2) {
    ...
    var SliderTrackFrame = (0, import_core24.styled)(import_SliderImpl.SliderFrame, {
      name: "SliderTrack",
      height: "100%",
      width: "100%",
      backgroundColor: "$background",
    ...
    var SliderTrackActiveFrame = (0, import_core24.styled)(import_SliderImpl.SliderFrame, {
    ...
    var SliderThumbFrame = (0, import_core24.styled)(import_stacks9.ThemeableStack, {
      name: "SliderThumb",
      position: "absolute",
      bordered: 2,
      borderWidth: 2,
      backgrounded: true,
      pressTheme: import_core24.isWeb,
      focusTheme: import_core24.isWeb,
      hoverTheme: import_core24.isWeb,
      variants: {
        size: {
          "...size": getThumbSize
        }
    ...
    var SliderThumb = React13.forwardRef(
      (props, forwardedRef) => {
        ...
        const [size2, setSize] = React13.useState(() => {
          const estimatedSize = (0, import_core24.getVariableValue)(getThumbSize(sizeIn).width);
    ...
    var Slider = (0, import_core24.withStaticProperties)(
      React13.forwardRef((props, forwardedRef) => {
        ...
        const [values = [], setValues] = (0, import_use_controllable_state3.useControllableState)({
          prop: value,
          defaultProp: defaultValue2,
          transition: true,
          onChange: (value2) => {
...
var require_Switch = __commonJS({
  "node_modules/@tamagui/switch/dist/cjs/Switch.js"(exports, module2) {
    ...
    var getSwitchHeight = /* @__PURE__ */ __name((val) => Math.round((0, import_core24.getVariableValue)((0, import_get_size2.getSize)(val)) * 0.65), "getSwitchHeight");
    var getSwitchWidth = /* @__PURE__ */ __name((val) => getSwitchHeight(val) * 2, "getSwitchWidth");
    var scopeContexts = (0, import_create_context6.createContextScope)(SWITCH_NAME);
    var [createSwitchContext] = scopeContexts;
    var createSwitchScope = scopeContexts[1];
    var [SwitchProvider, useSwitchContext] = createSwitchContext(SWITCH_NAME);
    var THUMB_NAME = "SwitchThumb";
    var SwitchThumbFrame = (0, import_core24.styled)(import_stacks9.ThemeableStack, {
      name: "SwitchThumb",
      variants: {
        unstyled: {
          false: {
        ...
        (props, forwardedRef) => {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
            SwitchThumbFrame,
            {
              ...
              "data-disabled": disabled ? "" : void 0,
              ...thumbProps,
              x: checked ? (0, import_core24.getVariableValue)(getSwitchWidth(size2)) - (0, import_core24.getVariableValue)(getSwitchHeight(size2)) : 0,
              ref: forwardedRef
            }
          );
        }
    ...
    var SwitchFrame = (0, import_core24.styled)(import_stacks9.XStack, {
      name: SWITCH_NAME,
      tag: "button",
      variants: {
        unstyled: {
    ...
    var Switch = (0, import_core24.withStaticProperties)(
      SwitchFrame.extractable(
        React13.forwardRef(
          (props, forwardedRef) => {
            ...
            const hasConsumerStoppedPropagationRef = React13.useRef(false);
            const isFormControl = import_core24.isWeb ? button ? Boolean(button.closest("form")) : true : false;
            const [checked = false, setChecked] = (0, import_use_controllable_state3.useControllableState)({
              prop: checkedProp,
            ...
            return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
              SwitchProvider,
              {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
                    SwitchFrame,
                    {
                      ...
                      onPress: (event) => {
                        ...
                        if (import_core24.isWeb && isFormControl) {
                          hasConsumerStoppedPropagationRef.current = event.isPropagationStopped();
                          if (!hasConsumerStoppedPropagationRef.current)
                            event.stopPropagation();
                        }
                  ...
                  import_core24.isWeb && isFormControl && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
                    BubbleInput,
                    {
                      control: button,
                      bubbles: !hasConsumerStoppedPropagationRef.current,
...
var require_Tooltip = __commonJS({
  "node_modules/@tamagui/tooltip/dist/cjs/Tooltip.js"(exports, module2) {
    ...
    var TooltipGroup = /* @__PURE__ */ __name(({ children, delay }) => {
      return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_react14.FloatingDelayGroup, { delay: React13.useMemo(() => delay, [JSON.stringify(delay)]), children });
    }, "TooltipGroup");
    var Tooltip = (0, import_core24.withStaticProperties)(
      (props) => {
        const {
          __scopePopover,
          children,
        ...
        const triggerRef = React13.useRef(null);
        const [hasCustomAnchor, setHasCustomAnchor] = React13.useState(false);
        const { delay: delayGroup, setCurrentId } = (0, import_react14.useDelayGroupContext)();
        const delay = delayProp ?? delayGroup;
        const [open, setOpen] = React13.useState(false);
        const id = props.groupId;
        const onOpenChange = (0, import_core24.useEvent)((open2) => {
          setOpen(open2);
          if (open2) {
            setCurrentId(id);
          }
        ...
        const useFloatingFn = /* @__PURE__ */ __name((props2) => {
          ...
          const { getReferenceProps, getFloatingProps } = (0, import_react14.useInteractions)([
            (0, import_react14.useHover)(floating.context, { delay, restMs }),
            (0, import_react14.useFocus)(floating.context, focus),
            (0, import_react14.useRole)(floating.context, { role: "tooltip" }),
            (0, import_react14.useDismiss)(floating.context),
            (0, import_react14.useDelayGroup)(floating.context, { id })
          ]);
          return {
            ...floating,
            getReferenceProps,
...
var require_TooltipSimple = __commonJS({
  "node_modules/@tamagui/tooltip/dist/cjs/TooltipSimple.js"(exports, module2) {
    ...
    var TooltipSimple = /* @__PURE__ */ __name(({
      ...
      let context;
      try {
        context = (0, import_react14.useDelayGroupContext)();
      } catch {
      }
...
var require_cjs43 = __commonJS({
  "node_modules/@tamagui/use-debounce/dist/cjs/index.js"(exports, module2) {
    ...
    function useDebounce(fn, wait, options = defaultOpts, mountArgs = []) {
      const dbEffect = (0, import_react14.useRef)(null);
      (0, import_react14.useEffect)(() => {
        return () => {
          var _a;
    ...
    function useDebounceValue(val, amt = 0) {
      const [state, setState] = (0, import_react14.useState)(val);
      (0, import_react14.useEffect)(() => {
        const tm = setTimeout(() => {
          setState((prev) => {
            if (prev === val)
...
var require_constants5 = __commonJS({
  "node_modules/@tamagui/constants/dist/cjs/constants.js"(exports, module2) {
    ...
    var useIsomorphicLayoutEffect3 = isRSC3 ? idFn4 : isServer2 ? import_react14.useEffect : import_react14.useLayoutEffect;
  ...
  "node_modules/@tamagui/use-window-dimensions/dist/cjs/index.js"(exports, module2) {
    ...
    function useWindowDimensions() {
      ...
      if (process.env.TAMAGUI_TARGET != "web")
        return current;
      const [state, setState] = (0, import_react14.useState)(initialValue);
...
var require_VisuallyHidden = __commonJS({
  "node_modules/@tamagui/visually-hidden/dist/cjs/VisuallyHidden.js"(exports, module2) {
    ...
    var import_web7 = require("@tamagui/core-node");
    var VisuallyHidden = (0, import_web7.styled)(import_web7.Stack, {
      position: "absolute",
      width: 1,
      height: 1,
      margin: -1,
...
var require_Checkbox = __commonJS({
  "node_modules/@tamagui/checkbox/dist/cjs/Checkbox.js"(exports, module2) {
    ...
    var CheckboxIndicatorFrame = (0, import_core24.styled)(import_stacks9.ThemeableStack, {
    ...
    var CheckboxFrame = (0, import_core24.styled)(import_stacks9.ThemeableStack, {
      name: CHECKBOX_NAME,
      tag: "button",
      variants: {
        unstyled: {
        ...
        size: {
          "...size": (val, { tokens }) => {
            const radiusToken = (0, import_core24.getVariableValue)((0, import_get_size2.getSize)(val)) / 8;
            return {
              borderRadius: radiusToken
            };
          }
    ...
    var [createCheckboxContext, createCheckboxScope] = (0, import_create_context6.createContextScope)(CHECKBOX_NAME);
    var [CheckboxProvider, useCheckboxContext] = createCheckboxContext(CHECKBOX_NAME);
    var Checkbox = (0, import_core24.withStaticProperties)(
      CheckboxFrame.extractable(
        React13.forwardRef(
          (props, forwardedRef) => {
            ...
            const [button, setButton] = React13.useState(null);
            const composedRefs = (0, import_core24.useComposedRefs)(forwardedRef, (node) => setButton(node));
            const hasConsumerStoppedPropagationRef = React13.useRef(false);
            const propsActive = (0, import_core24.useMediaPropsActive)(props);
            const isFormControl = import_core24.isWeb ? button ? Boolean(button.closest("form")) : true : false;
            const [checked = false, setChecked] = (0, import_use_controllable_state3.useControllableState)({
              prop: checkedProp,
            ...
            const adjustedSize = (0, import_core24.getVariableValue)(
            ...
            return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
              CheckboxProvider,
              {
                ...
                size: size2,
                scaleIcon,
                children: import_core24.isWeb && native ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
                  BubbleInput,
                  {
                    control: button,
                    bubbles: !hasConsumerStoppedPropagationRef.current,
  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    if (process.env.NODE_ENV !== "production") {
      (function() {
        ...
        var useState6 = React13.useState, useEffect9 = React13.useEffect, useLayoutEffect4 = React13.useLayoutEffect, useDebugValue2 = React13.useDebugValue;
  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    if (process.env.NODE_ENV !== "production") {
      (function() {
        ...
        var useRef8 = React13.useRef, useEffect9 = React13.useEffect, useMemo3 = React13.useMemo, useDebugValue2 = React13.useDebugValue;
...
function useStore(api, selector = api.getState, equalityFn) {
  ...
  (0, import_react12.useDebugValue)(slice);
  return slice;
}
var import_react12, import_with_selector, useSyncExternalStoreWithSelector, createImpl, create, react;
var init_esm = __esm({
  "node_modules/zustand/esm/index.js"() {
    init_vanilla();
    init_vanilla();
...
var require_dist5 = __commonJS({
  "node_modules/reforest/dist/index.js"(exports, module2) {
    ...
    var React13 = __toESM2(require("react"));
    var PrerenderContext = React13.createContext(false);
    PrerenderContext.displayName = "PrerenderContext";
    var MaxIndexContext = React13.createContext([]);
    MaxIndexContext.displayName = "MaxIndexContext";
    var IndexContext = React13.createContext(null);
    IndexContext.displayName = "IndexContext";
    var TreeStateContext = React13.createContext(null);
...
__export(esm_exports2, {
  ...
  Fieldset: () => Fieldset,
  FontLanguage: () => import_core23.FontLanguage,
  Footer: () => Footer,
  Form: () => Form,
  FormFrame: () => FormFrame,
  ...
  Spacer: () => import_core23.Spacer,
  Spinner: () => Spinner,
  Stack: () => import_core23.Stack,
  TamaguiProvider: () => TamaguiProvider,
  Text: () => import_core23.Text,
  TextAncestorContext: () => import_core23.TextAncestorContext,
  TextArea: () => TextArea,
  TextAreaFrame: () => TextAreaFrame,
  Theme: () => import_core23.Theme,
  ThemeableStack: () => ThemeableStack,
  Unspaced: () => import_core23.Unspaced,
  XGroup: () => XGroup,
  XStack: () => XStack,
  YGroup: () => YGroup,
  YStack: () => YStack,
  ZStack: () => ZStack,
  addTheme: () => import_core23.addTheme,
  buttonStaticConfig: () => buttonStaticConfig,
  composeRefs: () => composeRefs,
  createAvatarScope: () => createAvatarScope,
  createComponent: () => import_core23.createComponent,
  createDialogScope: () => createDialogScope,
  createFont: () => import_core23.createFont,
  createShorthands: () => import_core23.createShorthands,
  createTamagui: () => createTamagui,
  createTheme: () => import_core23.createTheme,
  createTokens: () => import_core23.createTokens,
  createVariable: () => import_core23.createVariable,
  defaultStyles: () => defaultStyles,
  fullscreenStyle: () => fullscreenStyle,
  getAnimationDriver: () => import_core23.getAnimationDriver,
  getConfig: () => import_core23.getConfig,
  getMedia: () => import_core23.getMedia,
  getStylesAtomic: () => import_core23.getStylesAtomic,
  getThemes: () => import_core23.getThemes,
  getTokens: () => import_core23.getTokens,
  getVariable: () => import_core23.getVariable,
  getVariableName: () => import_core23.getVariableName,
  getVariableValue: () => import_core23.getVariableValue,
  idFn: () => idFn,
  insertFont: () => import_core23.insertFont,
  isChrome: () => import_core23.isChrome,
  isClient: () => import_core23.isClient,
  isServer: () => import_core23.isServer,
  isServerSide: () => isServerSide,
  isTamaguiComponent: () => import_core23.isTamaguiComponent,
  isTamaguiElement: () => import_core23.isTamaguiElement,
  isTouchable: () => import_core23.isTouchable,
  isVariable: () => import_core23.isVariable,
  isWeb: () => import_core23.isWeb,
  isWebTouchable: () => import_core23.isWebTouchable,
  matchMedia: () => import_core23.matchMedia,
  mediaObjectToString: () => import_core23.mediaObjectToString,
  mediaQueryConfig: () => import_core23.mediaQueryConfig,
  mediaState: () => import_core23.mediaState,
  spacedChildren: () => import_core23.spacedChildren,
  styled: () => import_core23.styled,
  themeable: () => import_core23.themeable,
  updateTheme: () => import_core23.updateTheme,
  useButton: () => useButton,
  useComposedRefs: () => useComposedRefs,
  useControllableState: () => useControllableState,
  useDidFinishSSR: () => import_core23.useDidFinishSSR,
  useEvent: () => import_core23.useEvent,
  useForceUpdate: () => useForceUpdate,
  useFormContext: () => useFormContext,
  useGet: () => import_core23.useGet,
  useIsTouchDevice: () => import_core23.useIsTouchDevice,
  useIsomorphicLayoutEffect: () => import_core23.useIsomorphicLayoutEffect,
  useLabelContext: () => useLabelContext,
  useMedia: () => import_core23.useMedia,
  useSafeRef: () => import_core23.useSafeRef,
  useStyle: () => import_core23.useStyle,
  useTheme: () => import_core23.useTheme,
  useThemeName: () => import_core23.useThemeName,
  variableToString: () => import_core23.variableToString,
  withStaticProperties: () => import_core23.withStaticProperties,
...
// node_modules/tamagui/dist/esm/index.mjs
__reExport(esm_exports2, __toESM(require_cjs(), 1), module.exports);
__reExport(esm_exports2, __toESM(require_cjs22(), 1), module.exports);
__reExport(esm_exports2, __toESM(require_cjs5(), 1), module.exports);
...
// node_modules/tamagui/dist/esm/index.mjs
__reExport(esm_exports2, __toESM(require_cjs3(), 1), module.exports);
...
// node_modules/tamagui/dist/esm/index.mjs
__reExport(esm_exports2, __toESM(require_cjs25(), 1), module.exports);
...
// node_modules/tamagui/dist/esm/index.mjs
__reExport(esm_exports2, __toESM(require_cjs28(), 1), module.exports);
__reExport(esm_exports2, __toESM(require_cjs23(), 1), module.exports);
...
// node_modules/tamagui/dist/esm/index.mjs
__reExport(esm_exports2, __toESM(require_cjs30(), 1), module.exports);
__reExport(esm_exports2, __toESM(require_cjs33(), 1), module.exports);
__reExport(esm_exports2, __toESM(require_cjs32(), 1), module.exports);
__reExport(esm_exports2, __toESM(require_cjs13(), 1), module.exports);
__reExport(esm_exports2, __toESM(require_cjs34(), 1), module.exports);
__reExport(esm_exports2, __toESM(require_cjs36(), 1), module.exports);
__reExport(esm_exports2, __toESM(require_cjs17(), 1), module.exports);
__reExport(esm_exports2, __toESM(require_cjs38(), 1), module.exports);
__reExport(esm_exports2, __toESM(require_cjs37(), 1), module.exports);
__reExport(esm_exports2, __toESM(require_cjs24(), 1), module.exports);
__reExport(esm_exports2, __toESM(require_cjs18(), 1), module.exports);
__reExport(esm_exports2, __toESM(require_cjs40(), 1), module.exports);
__reExport(esm_exports2, __toESM(require_cjs41(), 1), module.exports);
__reExport(esm_exports2, __toESM(require_cjs42(), 1), module.exports);
__reExport(esm_exports2, __toESM(require_cjs43(), 1), module.exports);
...
// node_modules/tamagui/dist/esm/index.mjs
__reExport(esm_exports2, __toESM(require_cjs44(), 1), module.exports);
__reExport(esm_exports2, __toESM(require_cjs45(), 1), module.exports);
__reExport(esm_exports2, __toESM(require_cjs46(), 1), module.exports);

// node_modules/tamagui/dist/esm/createTamagui.js
var import_core11 = require("@tamagui/core-node");
var createTamagui = process.env.NODE_ENV !== "development" ? import_core11.createTamagui : (conf) => {
  const sizeTokenKeys = [
    "$0",
    "$1",
    "$2",
  ...
  const tamaguiConfig = (0, import_core11.createTamagui)(conf);
...
var TamaguiProvider = import_core12.isRSC ? import_core12.TamaguiProvider : ({ children, ...props }) => {
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(import_core12.TamaguiProvider, { ...props, children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(import_portal2.PortalProvider, { shouldAddRootHost: true, children }) });
};
...
var AnchorFrame = (0, import_core13.styled)(SizableText, {
  name: "Anchor",
  tag: "a",
...
var EnsureFlexed = (0, import_core14.styled)(import_core14.Text, {
  opacity: 0,
  lineHeight: 0,
  height: 0,
  display: "flex",
...
var Fieldset = (0, import_core15.styled)(YStack, {
  name: "Fieldset",
  tag: "fieldset",
  variants: {
    horizontal: {
...
var inputSizeVariant = /* @__PURE__ */ __name((val = "$true", extras) => {
  ...
  if (!import_core17.isWeb && fontStyle) {
...
var textAreaSizeVariant = /* @__PURE__ */ __name((val = "$true", extras) => {
  ...
  const buttonStyles = (0, import_get_button_sized4.getButtonSized)(val, extras);
  const fontStyle = (0, import_get_font_sized3.getFontSized)(val, extras);
  const height = props.numberOfLines ? (props.numberOfLines || 1) * (0, import_core17.getVariableValue)(fontStyle.lineHeight) : "auto";
...
// node_modules/tamagui/dist/esm/views/Input.js
(0, import_core18.setupReactNative)({
...
var InputFrame = (0, import_core18.styled)(
...
var import_create_context5 = __toESM(require_cjs3());
var import_react13 = __toESM(require("react"));
var import_react_native4 = require("react-native-web-lite");
var import_reforest = __toESM(require_dist5());
...
var GroupFrame = (0, import_core19.styled)(ThemeableStack, {
  name: "GroupFrame",
  variants: {
    unstyled: {
      false: {
...
function createGroup(verticalDefault) {
  return (0, import_core19.withStaticProperties)(
    (0, import_react13.forwardRef)((props, ref) => {
      const activeProps = (0, import_core19.useMediaPropsActive)(props);
      const {
        __scopeGroup,
        children: childrenProp,
        space,
        ...
        forceUseItem,
        ...restProps
      } = (0, import_core19.getExpandedShorthands)(activeProps);
      const vertical = axis === "vertical";
      const [itemChildrenCount, setItemChildrenCount] = useControllableState({
        defaultProp: forceUseItem ? 1 : 0
      });
      const isUsingItems = itemChildrenCount > 0;
      const radius = borderRadius ?? (size2 ? (0, import_core19.getVariableValue)((0, import_core19.getTokens)().radius[size2]) - 1 : void 0);
      const hasRadius = radius !== void 0;
      const disablePassBorderRadius = disablePassBorderRadiusProp ?? !hasRadius;
      const childrenArray = import_react13.Children.toArray(childrenProp);
      ...
      const onItemMount = import_react13.default.useCallback(
        () => setItemChildrenCount((prev) => prev + 1),
        []
      );
      const onItemUnmount = import_react13.default.useCallback(
        () => setItemChildrenCount((prev) => prev - 1),
        []
      );
...
var GroupItem = /* @__PURE__ */ __name((props) => {
  ...
  if (!context.disablePassBorderRadius) {
    ...
    if ((0, import_core19.isTamaguiElement)(children)) {
...
var cloneElementWithPropOrder = /* @__PURE__ */ __name((child, props) => {
  const next = (0, import_core19.mergeProps)(child.props, props, false, (0, import_core19.getConfig)().shorthands)[0];
  return import_react13.default.cloneElement({ ...child, props: null }, next);
}, "cloneElementWithPropOrder");

// node_modules/tamagui/dist/esm/views/Layouts.js
var import_core20 = require("@tamagui/core-node");
var Section = (0, import_core20.styled)(import_core20.Stack, {
  name: "Section",
  tag: "section",
  flexDirection: "column",
  accessibilityRole: "summary"
});
var Article = (0, import_core20.styled)(import_core20.Stack, {
  name: "Article",
  tag: "article",
  flexDirection: "column"
});
var Main = (0, import_core20.styled)(import_core20.Stack, {
  name: "Main",
  tag: "main",
  flexDirection: "column"
});
var Header = (0, import_core20.styled)(import_core20.Stack, {
  name: "Header",
  tag: "header",
  accessibilityRole: "header",
  flexDirection: "column"
});
var Aside = (0, import_core20.styled)(import_core20.Stack, {
  name: "Aside",
  tag: "aside",
  flexDirection: "column"
  // accessibilityRole: 'complementary',
});
var Footer = (0, import_core20.styled)(import_core20.Stack, {
  name: "Footer",
  tag: "footer",
  flexDirection: "column"
  // accessibilityRole: 'contentinfo',
});
var Nav = (0, import_core20.styled)(import_core20.Stack, {
  name: "Nav",
  tag: "nav",
  flexDirection: "column"
...
var TextAreaFrame = (0, import_core22.styled)(InputFrame, {
  name: "TextArea",
  multiline: true,
  variants: {
    unstyled: {
